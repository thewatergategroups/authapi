...
def upgrade() -> None:
    ...
    op.execute(sa.text("INSERT INTO auth.scopes (id_) VALUES ('openid')"))
    op.execute(sa.text("INSERT INTO auth.scopes (id_) VALUES ('email')"))
    op.execute(sa.text("INSERT INTO auth.scopes (id_) VALUES ('profile')"))
    op.create_table(
        "clients",
